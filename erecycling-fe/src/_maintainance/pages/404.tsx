...
const PageNotFound = () => {
  return (
    <div className="max-w-[600px] mx-auto mt-20 text-center ">
      <h1 className="text-6xl font-bold text-primary">Không có kết quả</h1>
      <span className="inline-block mx-auto mt-4 text-base">
        Xin lỗi! Địa chỉ bạn truy cập không tồn tại. Có thể URL bị hỏng hoặc quản trị viên đã xoá bỏ. Hãy kiểm tra liên kết bạn đang mở có chính xác không
      </span>
      <Link
        to={"/"}
        className="inline-block rounded-lg bg-primary w-[175px] text-white mt-4 cursor-pointer hover:bg-[rgba(0,_166,_111,_0.8)] py-2"
      >
        Trang chủ
      </Link>
      <div className="relative w-full h-[300px] my-8">
        <svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            ...
            opacity="0.2"
          ></path>
          <image href="/images/illustration/character_6.png" height="300" x="205" y="30"></image>
          <path
            fill="#FFAB00"
